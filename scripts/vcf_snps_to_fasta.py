...
parser.add_argument(
	'--vcf_list', help='A txt file that contains a list of VCF path',
	type=str)
parser.add_argument(
	'--max_amb_samples', type=int, default=1000000
	help='maximum number of samples with ambiguous calls for a site to be included', )
